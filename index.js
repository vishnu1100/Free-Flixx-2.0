...
const trailer= `http://api.themoviedb.org/3/movie/157336/videos?api_key=${apiKey}&query`;
...
function createMovieCard(movie) {
    ...
    const trailer = poster_path ? imgApi + poster_path : "./img-01.jpeg";
            ...
            <div class="card">
                ...
                <div class="card-content">
                    ...
                    <div class="right-content">
                        <a href="${imagePath}" target="_blank" class="card-btn">See Cover</a><br><br>
                        <a href="${trailer}"  target="_blank" class="card-btn">See Trailer</a>
                    </div>
                </div>
                <div class="info">
